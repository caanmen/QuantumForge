...
OUTPUT = ROOT / (
    ...
    "CANDIDATOS_V34/revision_unity_v34_contact_sheet.png"
)
...
def main() -> None:
    ...
    font = ImageFont.truetype(font_path, 22) if font_path.exists() else ImageFont.load_default()
    draw.text((24, 18),
              "REVISIÓN UNITY V34 — ALOJAMIENTO ANCHO + CARAS ABIERTAS V33",
              fill=(210, 230, 236), font=font)
