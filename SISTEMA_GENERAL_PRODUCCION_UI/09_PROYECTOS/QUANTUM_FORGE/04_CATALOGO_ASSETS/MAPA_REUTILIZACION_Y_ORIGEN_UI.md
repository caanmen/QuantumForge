...
| Campo orbital detallado del Árbol D1 | `Assets/Project/UI/Dimension1/Generated/Candidates/Tree/d1_tree_orbital_field_v1.png` | Candidato de pantalla; placa decorativa sin datos ni interacción |
...
| Cristal central | Geometría técnica en `Dimension1TreeReferenceSetup.cs` | No reutilizar el cristal sólido de Reliquias: cambia el medio gráfico de la referencia |
| Lectura de Reliquias | Constructor técnico D1 ya usado en Explorar | Reutilizar la variante correspondiente |
...
| Órbitas y conexiones | `Candidates/Tree/d1_tree_orbital_field_v1.png` más conectores UGUI | Placa sin datos detrás; conexiones y nodos continúan como elementos reales |
...
## Auditoría vigente — familia de detalles de sectores D1

| Elemento | Origen comprobado | Decisión obligatoria |
|---|---|---|
| Armazón, márgenes y navegación | Jerarquía de Órbitas Antiguas + navegación premium D1 | Reutilizar desde un instalador/controlador común; no crear copias divergentes |
| Planetas 1 y 2 | `d1_body_planet_blue_v3.png` y `d1_body_planet_molten_alpha_v2.png` | Reutilizar cuerpos de Carta Galáctica |
| Planeta 3 | `d1_body_debris_ring_v3.png` | Reutilizar y centrar la única tarjeta dentro del área conjunta |
| Planetas 6 y 7 | `d1_body_planet_silent_v3.png` con tratamientos de Carta Galáctica | Reutilizar sin inventar cuerpos alternativos |
| Nave Abandonada y Ruina Orbital | `Candidates/AncientOrbits/*_v2.png` | Reutilizar con clasificación de candidato |
| Seis destinos restantes | `Generated/Candidates/SectorDetails/d1_destination_*_v2.png` | Candidatos detallados con fondo oscuro integrado; no promover antes de aprobación |
| Datos planetarios y destinos | `GameState` y `Dimension1System` | Mostrar producción, costes, metales e IDs oficiales reales |

Los PNG V1 de SectorDetails conservan la cuadrícula horneada y sólo sirven como
trazabilidad del error; ninguna pantalla debe volver a referenciarlos.
...
| Nodo Centro Galáctico de Carta | `Generated/Candidates/ArkCenter/d1_galactic_center_black_hole_ship_candidate_v1.png` | Candidato generado desde el concepto elegido; usar estático y no promover antes de aprobación |
...
## Auditoría vigente — Expedición Completada D1

| Elemento | Origen comprobado | Decisión obligatoria |
|---|---|---|
| Marcos, relleno y estrellas | Assets canónicos D1 | Reutilizar sin crear otro sistema de paneles |
| Metales | `Generated/MetalsInventory/d1_metal_*_v5.png` | Resolver por ID real y centrar con preserveAspect |
| Nave utilizada | `d1_hangar_*_blueprint_v2.png` + `d1_hangar_blueprint_keyed.mat` | Reutilizar sprite y material como una unidad; no cargar el PNG aislado |
| Reliquia obtenida | Cámara de Reliquias y su mapa explícito ID→sprite | Reutilizar el mismo orden visual; nunca unirlo por índice al catálogo funcional ordenado por sector |
| Insignia y matrices | `Generated/Candidates/ExpeditionResult/*.png` | Candidatos nuevos por faltante real; no promover antes de aprobación |
| Resultado | `D1ExplorationRecordEntry` | Mostrar sólo destino, nave, duración, punto especial y premios realmente registrados |

El modal conserva Explorar activo debajo, cubre el viewport y al cerrarse deja su
CanvasGroup sin interacción ni raycasts.

## Auditoría vigente — Registro de Expediciones D1

| Elemento | Origen comprobado | Decisión obligatoria |
|---|---|---|
| Marcos, relleno, estrellas y fuente | Assets canónicos D1 | Reutilizar sin crear otro sistema visual |
| Destinos | `Candidates/AncientOrbits/*_v2.png` y `Candidates/SectorDetails/*_v2.png` | Resolver por ID estable; conservar su clasificación de candidato |
| Naves principal y de apoyo | `d1_hangar_*_blueprint_v2.png` + `d1_hangar_blueprint_keyed.mat` | Reutilizar como unidad; principal cian y apoyo coordinado ámbar |
| Metales de cabecera y fichas de fila | `Generated/MetalsInventory/d1_metal_*_v5.png` | Reutilizar assets reales; las fichas de fila leen ID y cantidad reales |
| Totales inferiores | `Generated/Candidates/ExpeditionRecordSummary/d1_record_summary_*_candidate_v1.png` + material black key | Tres candidatos específicos; no sustituir con navegación, un metal individual ni geometría textual |
| Reliquias y matrices | Catálogos ya conectados en Expedición Completada | Mostrar sólo el estado/recompensa registrada; no inventar otro premio |
| Historial | `dimension1RecentExplorationRecords` | Mostrar hasta 20 en orden inverso, con scroll y sin escribir guardado |
| Clave central | Estado real de ARK | Reservar una fila adicional; no contarla ni desplazar expediciones |

La pantalla superpone Explorar, reutiliza su autoridad de apertura/cierre y no incorpora
navegación inferior propia.
