...
public static class Dimension3FacilitiesImprovementValidation
{
    [MenuItem("Tools/Quantum Forge/Dimension 3/Validate Facilities Improvement Full")]
    public static void ValidateAll()
    {
        ...
        Dimension3FacilitiesVisualSetup.ValidateCurrentBatch();
        Debug.Log("[D3 Facilities Improvement Full Validation] PASS | variante Mejora | instalaciones N1-N5 | Main | layout móvil");
    }
